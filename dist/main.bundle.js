...
var AppComponent = (function () {
    function AppComponent(http) {
        ...
        this.requestOptions = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["c" /* RequestOptions */]({ headers: headers });
    }
    AppComponent.prototype.onClick = function () {
        this.http.get("https://2j162c91nb.execute-api.us-east-1.amazonaws.com/prod/lambda", this.requestOptions).subscribe(function (response) {
